...
uv pip install --no-build-isolation -v -e .  # --no-build-isolation is required for the latest version unlike the original repo without it, installation will fail..
